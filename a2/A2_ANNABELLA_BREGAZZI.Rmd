...
Table 5: Genes significantly differentially expressed after correction across clinical subtypes, aggregate design
...
Table 6: Genes significantly differentially expressed after correction associated with ER overexpression 
...
plot(top_hits$table$logFC, -10*log10(top_hits$table$PValue),
     main="Figure 3: Volcano Plot of significantly differentially 
     expressed genes after correction 
...
My associated journal entry wiki link for this assignment is [here](https://github.com/bcb420-2025/Annabella_Bregazzi/wiki/Assignment-2).
